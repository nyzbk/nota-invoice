  ...
  return (
    <main className="mx-auto w-full max-w-5xl overflow-x-hidden px-4 py-8">
      ...
      <p className="mt-3 max-w-xl text-sm leading-relaxed text-muted sm:text-base">
        ...
        Totals use integer cents. Cyrillic names print. Drafts stay on this device.
      </p>
      <p className="mt-4 rounded-lg border border-line bg-surface px-4 py-3 text-sm text-ink">
        ...
        <a href="/how-to" className="underline underline-offset-4">
          How it works
        </a>
        {" · "}
    ...
    <>
      ...
      <section className="grid gap-3 sm:grid-cols-3">
        ...
        <Field
          ...
          onChange={(e) => patch({ dueDate: e.target.value || addDays(invoice.issueDate, 14) })}
        />
      </section>
